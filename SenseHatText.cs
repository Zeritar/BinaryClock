...
{
    /// <summary>
    /// <para>Library for writing text to SenseHat LED Matrix.</para>
    ...
    public class SenseHatText
    {
        ...
        private SenseHatText()
        {
            ...
            var streamText = assembly.GetManifestResourceStream("BinaryClock.sense_hat_text.txt");
            if (streamText == null)
            {
            ...
            var streamPng = assembly.GetManifestResourceStream("BinaryClock.sense_hat_text.png");
            if (streamPng == null)
            {
        ...
        public void ShowMessage(SenseHatLedMatrix ledMatrix, string message, int scroll_speed = 30, Color? text_colour = null, Color? back_colour = null, bool isVertical = false)
        {
